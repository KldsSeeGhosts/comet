...
| Pi (native RPC) | done | Direct `pi --mode rpc --approve` driver; native provider/model discovery, session-file resume, command and usage events, typed tools, step-boundary steering, and minimal through max thinking levels. |
